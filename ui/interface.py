...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.original_image = QtWidgets.QGraphicsView(Form)
        self.original_image.setGeometry(QtCore.QRect(300, 50, 401, 281))
        self.original_image.setObjectName("original_image")
        self.mask_image = QtWidgets.QGraphicsView(Form)
        self.mask_image.setGeometry(QtCore.QRect(300, 340, 401, 281))
